<template>
  <div class="hello">
    <form action="" method="post" @submit.prevent="addAnimal">
      ...
      <select v-model="singleSector" name="" id="">

        <option v-for="(singleSector, index) in sectors" :key="index">{{singleSector}}</option>
      </select>
  ...
  methods: {
    ...
    addAnimal(){
      var newAnimal = {
        ...
        singleSector: this.singleSector
      }
